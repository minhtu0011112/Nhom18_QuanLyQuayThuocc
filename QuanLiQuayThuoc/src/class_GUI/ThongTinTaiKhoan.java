...
public class ThongTinTaiKhoan extends JFrame {
	...
	private static List<DangNhap> ldn;
	/**
...
//	}
	 ...
	 * Create the frame.
	 */
	public ThongTinTaiKhoan(String manv, int thongtin) {
		manv1 = manv;
		thongtin1 = thongtin;
		...
		JLabel lblThongtinnv = new JLabel("THÔNG TIN TÀI KHOẢN");
		...
		panel_1.setBounds(10, 11, 640, 312);
		panel.add(panel_1);
		...
		txtChucVu.setBounds(395, 262, 173, 27);
		...
		btnLuu.setBounds(380, 398, 123, 39);
		...
		btnDong.setBounds(515, 398, 124, 39);
		...
		lblTT.setBounds(168, 404, 91, 27);
		panel.add(lblTT);
		
		radTT = new JRadioButton("Đã nghỉ");
		radTT.setBackground(Color.WHITE);
		radTT.setBounds(265, 406, 109, 23);
		radTT.setFocusable(false);
		radTT.setEnabled(false);
		panel.add(radTT);
		
		JLabel lblNewLabel = new JLabel("Note: Nếu thông tin không đúng vui lòng liên hệ quản lí để sửa đổi");
		lblNewLabel.setBounds(10, 373, 418, 14);
		panel.add(lblNewLabel);
		
		JLabel lblMK = new JLabel("Mật khẩu:");
		lblMK.setToolTipText("");
		lblMK.setHorizontalAlignment(SwingConstants.LEFT);
		lblMK.setBounds(10, 334, 70, 28);
		panel.add(lblMK);
		
		txtPassword = new JPasswordField();
		txtPassword.setEditable(false);
		txtPassword.setBackground(Color.WHITE);
		txtPassword.setBounds(90, 334, 173, 27);
		txtPassword.setText("xxxxxxxxxxxxxxxxxxxxxxxxx");
		panel.add(txtPassword);
		
		JButton btnHT = new JButton("Hiển thị");
		btnHT.setFocusable(false);
		btnHT.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(status==1) {
					for(DangNhap s : ldn) {
						if(s.getMaTK().trim().equalsIgnoreCase(manv1.trim())) {
							panel.remove(txtPassword);
							txtPassword1 = new JTextField();
							txtPassword1.setBackground(Color.WHITE);
							txtPassword1.setBounds(90, 334, 173, 27);
							txtPassword1.setText(s.getMatKhau());
		...
		btnHT.setBounds(289, 334, 89, 28);
		panel.add(btnHT);
		
		JButton btnTD = new JButton("Thay đổi");
		btnTD.setFocusable(false);
		btnTD.setBounds(388, 334, 89, 28);
		btnTD.addActionListener(new ActionListener() {
			
			@Override
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				ChangePass_GUI chgpass = new ChangePass_GUI(manv1);
	...
	public static void DocDLDB() {
		lnv = qlnv_DAO.getAllNhanVienall();
	...
	private void docDLfromTable() {
		for(NhanVien s : lnv) {
			if(s.getMaNV().trim().equalsIgnoreCase(manv1.trim())) {
				...
				txtChucVu.setText(s.getChuVu().trim());
				if(s.getTinhTrang()==0)
