...
public class LoaiThuoc_ADD_GUI extends JFrame {
	...
	public LoaiThuoc_ADD_GUI() {
		ConnectDB.getInstance().connect();
		LT_DAO = new LoaiThuoc_DAO();
		
		setTitle("Thêm loại thuốc");
		...
		btnLuu.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (kTraDinhDang()) {
					...
					try {
						if(!LT_DAO.create(maLoai, tenLoaiThuoc))
							throw new Exception();
						else
